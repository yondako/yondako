...
const SvgSettingsFilled = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    fill="currentColor"
    className="settings-filled_svg__icon settings-filled_svg__icon-tabler settings-filled_svg__icons-tabler-filled settings-filled_svg__icon-tabler-settings"
    viewBox="0 0 24 24"
    {...props}
  >
