...
const SvgMoodEmptyFilled = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="mood-empty-filled_svg__icon mood-empty-filled_svg__icon-tabler mood-empty-filled_svg__icons-tabler-filled mood-empty-filled_svg__icon-tabler-mood-empty"
    viewBox="0 0 24 24"
    {...props}
  >
