...
const SvgSquareCheckFilled = (props: SVGProps<SVGSVGElement>) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="currentColor"
    className="square-check-filled_svg__icon square-check-filled_svg__icon-tabler square-check-filled_svg__icons-tabler-filled square-check-filled_svg__icon-tabler-square-check"
    viewBox="0 0 24 24"
    {...props}
  >
