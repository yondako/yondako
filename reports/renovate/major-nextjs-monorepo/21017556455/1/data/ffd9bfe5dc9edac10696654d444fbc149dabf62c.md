...
- generic [ref=e2]:
  ...
  - list [ref=e5]:
    ...
    - listitem [ref=e13]:
      ...
      - text: .
  - code [ref=e17]: "ReferenceError: require is not defined at node:module (http://localhost:6006/main.e89ee838.iframe.bundle.js:7:18933) at o (http://localhost:6006/runtime~main.df84db34.iframe.bundle.js:1:140) at ./node_modules/better-auth/dist/index.mjs (http://localhost:6006/6067.e0206b33.iframe.bundle.js:27:38539) at o (http://localhost:6006/runtime~main.df84db34.iframe.bundle.js:1:140) at ./src/components/BookDetail/index.tsx (http://localhost:6006/6542.e967e4f7.iframe.bundle.js:2:10028) at o (http://localhost:6006/runtime~main.df84db34.iframe.bundle.js:1:140) at ./src/components/BookCard/index.tsx (http://localhost:6006/components-BookList-index-stories.4929a315.iframe.bundle.js:48:2300) at o (http://localhost:6006/runtime~main.df84db34.iframe.bundle.js:1:140) at ./src/components/BookList/index.stories.tsx (http://localhost:6006/components-BookList-index-stories.4929a315.iframe.bundle.js:48:4483) at o (http://localhost:6006/runtime~main.df84db34.iframe.bundle.js:1:140)"
```